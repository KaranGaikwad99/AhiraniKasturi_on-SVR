"""
Django settings for marathi project.
...
ALLOWED_HOSTS = ['ahirani.herokuapp.com','www.ahiranikasturi.com']
...
WSGI_APPLICATION = 'marathi.wsgi.application'
